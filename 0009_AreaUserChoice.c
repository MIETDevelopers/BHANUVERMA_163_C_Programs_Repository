...
{
      int choice,r,l,b,s; //variable declaration of integer data type.
      ...
      switch(choice) 
      {
           ...
           case 1: 
            ...
            case 2:
                  ...
                  scanf("%d%d",&l,&b);//taking length and breadth as a input from the user.
            ...
            case 3:
                  ...
                  area=s*s; //formula of area of square.
                  break;
          }
